...
function* fetchMessages(action) {
    try {
        const { messages, nextFetchingRoom } = yield call(chatApi.messagesFetchRequested, action.roomId)
        yield put(chatActions.messagesFetchSucceed(action.roomId, messages, nextFetchingRoom))
